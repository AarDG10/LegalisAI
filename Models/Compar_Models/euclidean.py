...
# Streamlit UI
st.title("Legalis AI (Based on Euclidean Distance)")

# User input for case description
case_description = st.text_area("Enter your legal case description:")

# Semantic search function using Euclidean Distance
def find_relevant_sections(case_description, legal_sections, model, tokenizer):
    ...
    for section in legal_sections:
        ...
        distance = F.pairwise_distance(case_embedding, section_embedding).item()
        results.append((section['title'], section['text'], distance))
